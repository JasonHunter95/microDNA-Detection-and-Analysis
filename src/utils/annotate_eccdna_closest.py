...
def main():
    ...
    df = pd.read_csv("data/beds/chr1/SRR413984_chr1.eccdna.closest_genes.bed", sep='\t', header=None)
    ...
    for _, row in df.iterrows():
        ...
        result.append([
            ...
            gene_strand, gene_source, gene_feature_type, distance
        ])
    ...
    # save to TSV
    annotated.to_csv("data/results/chr1/SRR413984_chr1_closest.eccdna.annotated.tsv", sep='\t', index=False)
    print("✅ Saved annotated file to data/results/chr1/SRR413984_chr1_closest.eccdna.annotated.tsv")
