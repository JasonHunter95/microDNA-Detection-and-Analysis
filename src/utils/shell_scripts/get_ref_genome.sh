...
curl -L -o data/human_genome/GCF_000001405.13_GRCh37_genomic.fna.gz \
...
if [ ! -f data/human_genome/GCF_000001405.13_GRCh37_genomic.fna.gz ]; then
...
gunzip data/human_genome/GCF_000001405.13_GRCh37_genomic.fna.gz
# Check if unzip succeeded
if [ ! -f data/human_genome/GCF_000001405.13_GRCh37_genomic.fna ]; then
